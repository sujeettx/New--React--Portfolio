...
const Data = () => {
  ...
  const originalText = "Sujeet Kushwaha";
  ...
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">Jr. Full stack Developer</h3>
      <p className="home__description">I'm a creative Full Stack developer based in Satna, and I'm very passionate and dedicated to my work.</p>

      <a href="https://cal.com/sujeet-kushwaha-xr7ca7" className="button button--flex">
        Say Hello
        <svg
